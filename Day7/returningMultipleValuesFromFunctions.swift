...
// This code pulls apart the return value from getTaylor() into two separate constants

// if you don't need all the data from the tuple, you can use "_" to ignore that part of the
// tuple.

let (firstName, _) = getTaylor() 
